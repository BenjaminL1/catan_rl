# GENERATED — faithful copy of src/catan_rl/policy/network.py @ 501b3d2
# (the last commit before the pointer-arch fork). DO NOT EDIT BY HAND.
# Regenerate: python scripts/vendor_legacy_arch.py
# See the catan_rl.eval.legacy_arch package + _provenance.py for rationale.
...
from catan_rl.eval.legacy_arch.encoders import (
    CountDevEncoder,
    GraphEncoder,
    TileEncoder,
    curr_player_encoder,
...
from catan_rl.eval.legacy_arch.heads import BeliefHead, CatanActionHeads, ValueHead
from catan_rl.eval.legacy_arch.obs_schema import (
    N_OPP_KINDS,
    N_OPP_POLICY_SLOTS,
    N_TILES,
)
