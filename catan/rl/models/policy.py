...
from catan.rl.models.observation_module import ObservationModule
from catan.rl.models.action_heads_module import MultiActionHeads
...
class CatanPolicy(nn.Module):
    ...
    def __init__(self, obs_output_dim: int = 512,
    ...
    def act(self, obs: Dict[str, torch.Tensor], masks: Dict[str, torch.Tensor],
    ...
    def evaluate_actions(self, obs: Dict[str, torch.Tensor], masks: Dict[str, torch.Tensor],
