...
class CurrentPlayerModule(nn.Module):
    ...
    def forward(self, main_input, hidden_dev_cards, played_dev_cards,
                dev_card_embedding, hidden_card_mha, played_card_mha):
        # Hidden dev cards
        ...
        hidden_dev_representations = self.norm(
            hidden_card_mha(hidden_dev_card_embeddings,
        ...
        hidden_dev_representations[hidden_dev_card_masks_2.repeat(
            1, 1, hidden_dev_representations.shape[-1]) == 0] = 0.0
        ...
        played_dev_representations = self.norm(
            played_card_mha(played_dev_card_embeddings,
        ...
        played_dev_representations[played_dev_card_masks_2.repeat(
            1, 1, played_dev_representations.shape[-1]) == 0] = 0.0
