"""Decoupled setup model training infrastructure.

This module implements a separate training pipeline for the setup phase
(initial settlement and road placement) in 1v1 Catan.
...
See setup_env.py → SetupEnv
    setup_policy.py → SetupPolicy
